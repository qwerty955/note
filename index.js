...
document.getElementById("save").addEventListener("click",()=>{
    ...
    let crrr = document.createElement("div");
    let crrrr = document.createElement("div");
    ...
    crrr.className="outer";
    crrrr.className="inner";
    r.className="loi";
    crr.appendChild(crrr)
    crrr.appendChild(crrrr)
    crrrr.appendChild(r)
    r.innerHTML="DELETE";
